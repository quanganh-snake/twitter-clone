				...
				<form className="lg:w-2/3  mx-auto md:mx-20 flex gap-4 flex-col" onSubmit={handleSubmit}>
					...
					<div className="flex gap-4 flex-wrap">
						...
						<label className="input input-bordered rounded flex items-center gap-2 flex-1">
							...
							<input type="text" className="grow" placeholder="Full Name" name="fullname" onChange={handleInputChange} value={formData.fullname} />
						</label>
					</div>
					<label className="input input-bordered rounded flex items-center gap-2">
						<MdPassword />
					...
					<button className="btn rounded-full btn-primary text-white">{isPending ? "Signing up..." : "Sign up"}</button>
